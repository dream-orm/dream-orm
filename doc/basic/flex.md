...
目前，`dream-orm`已支持 80+ 个常见的 SQL
函数，查看已支持的  [所有函数](https://gitee.com/moxiaoai/dream-orm/blob/master/dream-orm-flex/src/main/java/com/dream/flex/def/FunctionDef.java) 。
若还不满足，您可以参考 [FunctionDef](https://gitee.com/moxiaoai/dream-orm/blob/master/dream-orm-flex/src/main/java/com/dream/flex/def/FunctionDef.java)
，然后在自己的项目里进行自定义扩展。
