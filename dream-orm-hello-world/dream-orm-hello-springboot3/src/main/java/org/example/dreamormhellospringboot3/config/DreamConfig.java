package org.example.dreamormhellospringboot3.config;

import com.dream.boot.bean.ConfigurationBean;
import com.dream.template.sequence.Sequence;
import com.zaxxer.hikari.HikariDataSource;
import org.example.dreamormhellospringboot3.sequence.SnowFlakeSequence;
...
public class DreamConfig {
    ...
    public ConfigurationBean configurationBean() {
        List<String> packages = Arrays.asList("org.example.dreamormhellospringboot3");
