package com.moxa.dream.share;

import com.moxa.dream.boot.bean.ConfigurationBean;
import com.moxa.dream.boot.share.EnableShare;
...
public class ShareApplication {
    ...
    public ConfigurationBean configurationBean() {
        ConfigurationBean configurationBean = new ConfigurationBean(Arrays.asList("com.moxa.dream.share"), Arrays.asList("com.moxa.dream.share"));
