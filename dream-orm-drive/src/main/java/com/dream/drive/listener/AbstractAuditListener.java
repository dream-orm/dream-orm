...
public abstract class AbstractAuditListener implements Listener {
            ...
            if (tableInfo != null) {
                ...
                if (!ObjectUtil.isNull(primKeys)) {
                    ...
                    if (Command.INSERT.equals(command)) {
                        ...
                        Map<String, Object> valueMap = query(tableInfo, columnValueMap.keySet(), primValueMap);
                        for (Map.Entry<String, Object> entry : columnValueMap.entrySet()) {
                        ...
                        Map<String, Object> valueMap = query(tableInfo, null, primValueMap);
                        if (valueMap != null) {
    ...
    protected abstract Map<String, Object> query(TableInfo tableInfo, Set<String> columnSet, Map<String, Object> primValueMap);
